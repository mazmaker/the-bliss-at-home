 ...
 * Types for booking cancellation and refund management
 */
...
export interface BookingCancellationRequest {
  ...
  refund_percentage?: number // Required if refund_option is 'partial'
...
export interface RefundInfo {
  ...
  percentage: number
  status: RefundStatus
  expected_days: number // Expected number of days for refund to complete
}
