  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-bliss-900">ตั้งค่า</h1>
          <p className="text-bliss-500">Settings - {getHotelName()}</p>
        </div>
        <button
          onClick={handleSave}
          disabled={saveSettingsMutation.isPending || !isDirty}
          title={!isDirty ? 'ไม่มีการเปลี่ยนแปลง' : undefined}
          className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-bliss-700 to-bliss-800 text-white rounded-xl font-medium hover:from-bliss-800 hover:to-bliss-900 transition disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        <div className="lg:col-span-3">
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-bliss-100">
            {activeTab === 'notifications' && (
              <div className="space-y-6">
                <h2 className="text-xl font-semibold text-bliss-900 mb-4">การแจ้งเตือน</h2>

                <div className="space-y-4">
                  <label className="flex items-center justify-between p-4 bg-bliss-50 rounded-xl cursor-pointer hover:bg-bliss-100">
                    <div>
                      <p className="font-medium text-bliss-900">แจ้งเตือนทางอีเมล</p>
                      <p className="text-sm text-bliss-500">รับแจ้งเตือนการจองใหม่ทางอีเมล</p>
                    </div>
                    <input
                      type="checkbox"
                      checked={settings.emailNotifications}
                      onChange={(e) => updateSetting('emailNotifications', e.target.checked)}
                      className="w-5 h-5 text-bliss-700 rounded focus:ring-2 focus:ring-bliss-500 bg-white border-bliss-300"
                    />
                  </label>

                  <label className="flex items-center justify-between p-4 bg-bliss-50 rounded-xl cursor-pointer hover:bg-bliss-100">
                    <div>
                      <p className="font-medium text-bliss-900">แจ้งเตือนทาง SMS</p>
                      <p className="text-sm text-bliss-500">รับแจ้งเตือนการจองใหม่ทาง SMS</p>
                    </div>
                    <input
                      type="checkbox"
            ...
            {activeTab === 'security' && (
              <div className="space-y-6">
                <h2 className="text-xl font-semibold text-bliss-900 mb-4">ความปลอดภัย</h2>

                <div className="space-y-4">
                  <label className="flex items-center justify-between p-4 bg-bliss-50 rounded-xl cursor-pointer hover:bg-bliss-100">
                    <div>
                      <p className="font-medium text-bliss-900">ยืนยันการจองอัตโนมัติ</p>
                      <p className="text-sm text-bliss-500">การจองจะได้รับการยืนยันโดยอัตโนมัติ</p>
                    </div>
                    <input
                      type="checkbox"
                  ...
                  <label className="flex items-center justify-between p-4 bg-bliss-50 rounded-xl cursor-pointer hover:bg-bliss-100">
                    <div>
                      <p className="font-medium text-bliss-900">บังคับกรอกข้อมูลแขก</p>
                      <p className="text-sm text-bliss-500">ต้องกรอกชื่อแขกและเลขห้องทุกครั้ง</p>
                    </div>
                    <input
                      type="checkbox"
                ...
                <div className="border-t border-bliss-200 pt-6">
                  <h3 className="text-lg font-semibold text-bliss-900 mb-4">เปลี่ยนรหัสผ่าน</h3>
                  ...
                  <div className="space-y-4">
                    {/* Current Password */}
                    <div>
                      <label className="block text-sm font-medium text-bliss-700 mb-2">รหัสผ่านปัจจุบัน</label>
                      <div className="relative">
                        <input
                          ...
                          className="w-full px-4 py-2 pr-10 border border-bliss-300 rounded-xl focus:ring-2 focus:ring-bliss-500 focus:border-bliss-500 bg-white text-bliss-900"
                        />
                        <button
                          type="button"
                    ...
                    {/* New Password */}
                    <div>
                      <label className="block text-sm font-medium text-bliss-700 mb-2">รหัสผ่านใหม่</label>
                      <div className="relative">
                        <input
                    ...
                    {newPassword.length > 0 && (
                      <div className="grid grid-cols-2 gap-2 text-xs">
                        <div className={`flex items-center gap-1.5 ${passwordChecks.minLength ? 'text-green-600' : 'text-bliss-400'}`}>
                          <CheckCircle2 className="w-3.5 h-3.5" /> อย่างน้อย 8 ตัวอักษร
                        </div>
                        <div className={`flex items-center gap-1.5 ${passwordChecks.hasUppercase ? 'text-green-600' : 'text-bliss-400'}`}>
                          <CheckCircle2 className="w-3.5 h-3.5" /> ตัวพิมพ์ใหญ่ (A-Z)
                        </div>
                        <div className={`flex items-center gap-1.5 ${passwordChecks.hasLowercase ? 'text-green-600' : 'text-bliss-400'}`}>
                          <CheckCircle2 className="w-3.5 h-3.5" /> ตัวพิมพ์เล็ก (a-z)
                        </div>
                        <div className={`flex items-center gap-1.5 ${passwordChecks.hasNumbers ? 'text-green-600' : 'text-bliss-400'}`}>
                          <CheckCircle2 className="w-3.5 h-3.5" /> ตัวเลข (0-9)
                        </div>
                        <div className={`flex items-center gap-1.5 ${passwordChecks.hasSpecialChar ? 'text-green-600' : 'text-bliss-400'}`}>
                    ...
                    {/* Confirm Password */}
                    <div>
                      <label className="block text-sm font-medium text-bliss-700 mb-2">ยืนยันรหัสผ่านใหม่</label>
                      <div className="relative">
                        <input
                          ...
                          className={`w-full px-4 py-2 pr-10 border rounded-xl focus:ring-2 focus:ring-bliss-500 focus:border-bliss-500 bg-white text-bliss-900 ${
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-bliss-700 to-bliss-800 text-white rounded-xl font-medium hover:from-bliss-800 hover:to-bliss-900 transition disabled:opacity-50 disabled:cursor-not-allowed"
                    >
