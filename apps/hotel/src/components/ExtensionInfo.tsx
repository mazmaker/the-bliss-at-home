...
import { Clock, DollarSign, Calendar, TrendingUp, Plus } from 'lucide-react';
  ...
  return (
    <div className={`bg-blue-50 border border-blue-200 rounded-xl p-4 ${className}`}>
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="font-semibold text-blue-800">การเพิ่มเวลาบริการ</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
        ...
        <div className="bg-white rounded-lg p-3 border border-blue-100">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm text-gray-600 font-medium">บริการเดิม</span>
          </div>
          <div className="space-y-1">
            <div className="font-bold text-gray-800">{originalDuration} นาที</div>
        ...
        <div className="bg-white rounded-lg p-3 border border-blue-100">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm text-amber-600 font-medium">เวลาเพิ่ม</span>
          </div>
          <div className="space-y-1">
            <div className="font-bold text-amber-700">+{totalExtensionTime} นาที</div>
            <div className="font-bold text-amber-600">+฿{totalExtensionPrice.toLocaleString()}</div>
          </div>
        </div>
