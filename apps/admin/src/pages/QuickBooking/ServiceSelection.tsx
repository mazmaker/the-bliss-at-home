                    ...
                    return (
                      <button
                        ...
                        className={`
                          ...
                          ${isSelected
                            ? 'border-[#d29b25] bg-gradient-to-r from-[#ffe79d] to-[#ffe79d]/70 shadow-lg transform scale-[1.01]'
                            : 'border-stone-200 bg-white hover:border-[#d29b25]/50 hover:bg-[#ffe79d]/20 hover:shadow-lg'
                          }
