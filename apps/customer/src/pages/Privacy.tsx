      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-6 border border-stone-100">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-stone-900">{t('legal:privacy.title')}</h1>
              <p className="text-stone-600">{t('legal:privacy.subtitle')}</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6 border border-stone-100">
          <h3 className="text-lg font-semibold text-stone-900 mb-4">{t('legal:privacy.tocHeading')}</h3>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-stone-100">
          <div className="prose prose-stone max-w-none">
            ...
            <section id="section-1" className="mb-8 scroll-mt-6">
              <h2 className="text-2xl font-semibold text-stone-900 mb-4">{t('legal:privacy.s1.heading')}</h2>

              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s1.h1')}</h3>
              <p className="text-stone-700 mb-2">{t('legal:privacy.s1.p1')}</p>
              ...
              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s1.h2')}</h3>
              <p className="text-stone-700 mb-2">{t('legal:privacy.s1.p2')}</p>
              <ul className="list-disc pl-6 text-stone-700 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s1.h3')}</h3>
            ...
            <section id="section-2" className="mb-8 scroll-mt-6">
              <h2 className="text-2xl font-semibold text-stone-900 mb-4">{t('legal:privacy.s2.heading')}</h2>

              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s2.h1')}</h3>
              <ul className="list-disc pl-6 text-stone-700 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s2.h2')}</h3>
              <ul className="list-disc pl-6 text-stone-700 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s2.h3')}</h3>
              <ul className="list-disc pl-6 text-stone-700 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s2.h4')}</h3>
              <ul className="list-disc pl-6 text-stone-700 space-y-2">
            ...
            <section id="section-3" className="mb-8 scroll-mt-6">
              <h2 className="text-2xl font-semibold text-stone-900 mb-4">{t('legal:privacy.s3.heading')}</h2>

              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s3.h1')}</h3>
              <ul className="list-disc pl-6 text-stone-700 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s3.h2')}</h3>
              <ul className="list-disc pl-6 text-stone-700 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s3.h3')}</h3>
            ...
            <section id="section-4" className="mb-8 scroll-mt-6">
              <h2 className="text-2xl font-semibold text-stone-900 mb-4">{t('legal:privacy.s4.heading')}</h2>
              ...
              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s4.h1')}</h3>
              <ul className="list-disc pl-6 text-stone-700 space-y-2">
            ...
            <section id="section-5" className="mb-8 scroll-mt-6">
              <h2 className="text-2xl font-semibold text-stone-900 mb-4">{t('legal:privacy.s5.heading')}</h2>

              <p className="text-stone-700 mb-4">
                {t('legal:privacy.s5.p1')}
              </p>

              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s5.h1')}</h3>
              <p className="text-stone-700 mb-4">
                {t('legal:privacy.s5.p1text')}
              </p>

              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s5.h2')}</h3>
              <p className="text-stone-700 mb-4">
                {t('legal:privacy.s5.p2text')}
              </p>

              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s5.h3')}</h3>
              <p className="text-stone-700 mb-4">
                {t('legal:privacy.s5.p3text')}
              </p>

              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s5.h4')}</h3>
              <p className="text-stone-700 mb-4">
                {t('legal:privacy.s5.p4text')}
              </p>

              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s5.h5')}</h3>
              <p className="text-stone-700 mb-4">
                {t('legal:privacy.s5.p5text')}
              </p>

              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s5.h6')}</h3>
              <p className="text-stone-700 mb-4">
                {t('legal:privacy.s5.p6text')}
              </p>

              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s5.h7')}</h3>
              <p className="text-stone-700 mb-4">
            ...
            <section id="section-6" className="mb-8 scroll-mt-6">
              <h2 className="text-2xl font-semibold text-stone-900 mb-4">{t('legal:privacy.s6.heading')}</h2>

              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s6.h1')}</h3>
              <p className="text-stone-700 mb-4">
                {t('legal:privacy.s6.p1')}
              </p>

              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s6.h2')}</h3>
              <ul className="list-disc pl-6 text-stone-700 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-medium text-stone-800 mb-3 mt-4">{t('legal:privacy.s6.h3')}</h3>
              <p className="text-stone-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-stone-900 mb-4">{t('legal:privacy.s7.heading')}</h2>
              <p className="text-stone-700 mb-4">
            ...
            {/* Section 8 */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-stone-900 mb-4">{t('legal:privacy.s8.heading')}</h2>
              <p className="text-stone-700 mb-4">
            ...
            {/* Section 9 */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-stone-900 mb-4">{t('legal:privacy.s9.heading')}</h2>
              <p className="text-stone-700 mb-4">
            ...
            {/* Section 10 */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-stone-900 mb-4">{t('legal:privacy.s10.heading')}</h2>
              <p className="text-stone-700 mb-4">
                {t('legal:privacy.s10.p1')}
              </p>
              <div className="bg-stone-50 p-6 rounded-lg border border-stone-200">
                <p className="text-stone-700 mb-2"><strong>{t('legal:privacy.s10.dpo')}</strong></p>
                <p className="text-stone-700 mb-2"><strong>{t('legal:privacy.s10.company')}</strong></p>
                <p className="text-stone-700 mb-2">{t('legal:privacy.s10.email')}</p>
                <p className="text-stone-700 mb-2">{t('legal:privacy.s10.phone')}</p>
                <p className="text-stone-700 mb-2">{t('legal:privacy.s10.line')}</p>
                <p className="text-stone-700 mb-4">{t('legal:privacy.s10.hours')}</p>
            ...
            {/* Section 11 */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-stone-900 mb-4">{t('legal:privacy.s11.heading')}</h2>
              <p className="text-stone-700 mb-4">
                {t('legal:privacy.s11.p1')}
              </p>
              <div className="bg-amber-50 p-6 rounded-lg border border-amber-200">
                <p className="text-amber-900 mb-2"><strong>{t('legal:privacy.s11.office')}</strong></p>
                <p className="text-amber-800 mb-2">{t('legal:privacy.s11.website')}</p>
                <p className="text-amber-800">{t('legal:privacy.s11.phone')}</p>
              </div>
            </section>
