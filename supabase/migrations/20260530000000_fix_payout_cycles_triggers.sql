-- Migration: Fix Payout Cycles Migration - Handle Existing Triggers
-- Created: 2026-05-30
-- Purpose: Properly handle existing triggers and complete payout system migration
...
-- ============================================
-- 7. Handle existing trigger properly
-- ============================================
-- Drop the existing trigger if it exists
DROP TRIGGER IF EXISTS staff_payout_date_trigger ON staff;
...
-- Create the trigger (it was dropped above so this is safe)
...
-- Insert default schedule options (with conflict handling)
...
DROP POLICY IF EXISTS "Allow read payout schedule settings" ON payout_schedule_settings;
...
-- ============================================
-- 11. Handle updated_at trigger for settings table
-- ============================================
-- Check if the trigger exists before creating
DROP TRIGGER IF EXISTS update_payout_schedule_settings_updated_at ON payout_schedule_settings;

-- Only create if update_updated_at_column function exists
DO $$
BEGIN
...
-- Done!
-- ============================================
SELECT 'Fixed payout cycles migration completed successfully!' as status;