-- Fix Analytics Function Timestamp Types
-- Created: 2026-02-12
-- Purpose: Fix timestamp with time zone vs timestamp without time zone mismatch

-- ============================================
-- FIX STAFF PERFORMANCE FUNCTION
-- ============================================
...
-- ============================================
-- ALSO FIX HOTEL PERFORMANCE FUNCTION
-- (just in case it has similar issues)
-- ============================================

-- No changes needed for get_hotel_performance_detailed as it doesn't return timestamps in problematic positions
...
COMMENT ON FUNCTION get_staff_performance_detailed IS 'Fixed staff performance analytics function - timestamp types corrected';